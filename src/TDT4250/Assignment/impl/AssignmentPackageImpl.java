...
import TDT4250.Assignment.AssignmentFactory;
...
public class AssignmentPackageImpl extends EPackageImpl implements AssignmentPackage {
	 ...
	 * @generated
	 */
	private EEnum semesterSeasonEEnum = null;
	 ...
	 * @see TDT4250.Assignment.AssignmentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static AssignmentPackage init() {
		...
		AssignmentPackageImpl theAssignmentPackage = registeredAssignmentPackage instanceof AssignmentPackageImpl ? (AssignmentPackageImpl)registeredAssignmentPackage : new AssignmentPackageImpl();
	 ...
	 */
	@Override
	public EReference getProgramme_Semester() {
	 ...
	 */
	@Override
	public EAttribute getCourseGroup_CourseGroupType() {
	 ...
	 */
	@Override
	public EReference getSpecialisation_Programme() {
	 ...
	 */
	@Override
	public EReference getSpecialisation_Semester() {
	 ...
	 */
	@Override
	public EReference getSpecialisation_CourseGroups() {
	 ...
	 */
	@Override
	public EEnum getSemesterSeason() {
		return semesterSeasonEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEReference(programmeEClass, PROGRAMME__SEMESTER);
		...
		createEAttribute(courseGroupEClass, COURSE_GROUP__COURSE_GROUP_TYPE);
		...
		createEReference(specialisationEClass, SPECIALISATION__PROGRAMME);
		createEReference(specialisationEClass, SPECIALISATION__SEMESTER);
		createEReference(specialisationEClass, SPECIALISATION__COURSE_GROUPS);
		...
		// Create enums
		semesterSeasonEEnum = createEEnum(SEMESTER_SEASON);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProgramme_ProgrammeCode(), ecorePackage.getEString(), "programmeCode", null, 0, 1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProgramme_Type(), this.getProgrammeType(), "Type", null, 0, 1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProgramme_Semester(), this.getsemester(), null, "semester", null, 0, -1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProgramme_Specialisation(), this.getSpecialisation(), this.getSpecialisation_Programme(), "specialisation", null, 0, -1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(semesterEClass, semester.class, "semester", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getsemester_Year(), ecorePackage.getEString(), "year", null, 0, 1, semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getsemester_SemesterType(), this.getSemesterSeason(), "semesterType", null, 0, 1, semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCourseGroup_CourseGroupType(), this.getCourseGroupType(), "courseGroupType", null, 0, 1, CourseGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSpecialisation_Programme(), this.getProgramme(), this.getProgramme_Specialisation(), "programme", null, 0, 1, Specialisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSpecialisation_Semester(), this.getsemester(), null, "semester", null, 0, 1, Specialisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSpecialisation_CourseGroups(), this.getCourseGroup(), null, "courseGroups", null, 0, 2, Specialisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(semesterSeasonEEnum, SemesterSeason.class, "SemesterSeason");
		addEEnumLiteral(semesterSeasonEEnum, SemesterSeason.AUTUMN);
		addEEnumLiteral(semesterSeasonEEnum, SemesterSeason.SPRING);

		initEEnum(courseGroupTypeEEnum, CourseGroupType.class, "CourseGroupType");
		addEEnumLiteral(courseGroupTypeEEnum, CourseGroupType.MANDATORY);
		addEEnumLiteral(courseGroupTypeEEnum, CourseGroupType.ELECTIVE);

		initEEnum(programmeTypeEEnum, ProgrammeType.class, "ProgrammeType");
		addEEnumLiteral(programmeTypeEEnum, ProgrammeType.BACHELOR);
		addEEnumLiteral(programmeTypeEEnum, ProgrammeType.MASTER2_YEARS);
		addEEnumLiteral(programmeTypeEEnum, ProgrammeType.MASTER5_YEARS);
