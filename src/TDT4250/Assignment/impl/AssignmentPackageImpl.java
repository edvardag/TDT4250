...
import TDT4250.Assignment.util.AssignmentValidator;
...
public class AssignmentPackageImpl extends EPackageImpl implements AssignmentPackage {
	...
	public static AssignmentPackage init() {
		...
		EValidator.Registry.INSTANCE.put
			(theAssignmentPackage,
			 new EValidator.Descriptor() {
				 @Override
				 public EValidator getEValidator() {
					 return AssignmentValidator.INSTANCE;
				 }
			 });
	 ...
	 */
	@Override
	public EReference getsemester_RequiredCourses() {
	...
	public void createPackageContents() {
		...
		createEReference(semesterEClass, SEMESTER__REQUIRED_COURSES);
	...
	public void initializePackageContents() {
		...
		initEReference(getsemester_RequiredCourses(), this.getCourse(), null, "requiredCourses", null, 0, -1, semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (courseEClass,
		   source,
		   new String[] {
			   "constraints", "AcceptedAmountOfCredit"
		   });
		addAnnotation
		  (programmeEClass,
		   source,
		   new String[] {
			   "constraints", "TotalCreditCheck"
		   });
		addAnnotation
		  (semesterEClass,
		   source,
		   new String[] {
			   "constraints", "Minimum30creditPerSemester AllRequiredCoursesCheck"
		   });
		addAnnotation
		  (specialisationEClass,
		   source,
		   new String[] {
			   "constraints", "MandatoryCoursesCheck"
		   });
	}
