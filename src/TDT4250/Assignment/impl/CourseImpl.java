 ...
 * </p>
 * <ul>
 *   <li>{@link TDT4250.Assignment.impl.CourseImpl#getName <em>Name</em>}</li>
 *   <li>{@link TDT4250.Assignment.impl.CourseImpl#getCourseCode <em>Course Code</em>}</li>
 *   <li>{@link TDT4250.Assignment.impl.CourseImpl#getCredit <em>Credit</em>}</li>
 *   <li>{@link TDT4250.Assignment.impl.CourseImpl#getLevel <em>Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseImpl extends MinimalEObjectImpl.Container implements Course {
	...
	public void setCourseCode(String newCourseCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignmentPackage.COURSE__COURSE_CODE, oldCourseCode, courseCode));
	}
	...
	public void setCredit(float newCredit) {
		...
		credit = newCredit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignmentPackage.COURSE__CREDIT, oldCredit, credit));
	}
	...
	public void setLevel(String newLevel) {
		...
		level = newLevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignmentPackage.COURSE__LEVEL, oldLevel, level));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssignmentPackage.COURSE__NAME:
				return getName();
			case AssignmentPackage.COURSE__COURSE_CODE:
				return getCourseCode();
			case AssignmentPackage.COURSE__CREDIT:
				return getCredit();
			case AssignmentPackage.COURSE__LEVEL:
				return getLevel();
		}
